...
<head>
    ...
    <title>Forgot Password – University Analytics Dashboard</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        p.sub { color: var(--primary-mid); margin-bottom: 2.5rem; font-size: 1rem; font-weight: 500; text-align: center; line-height: 1.5; }
...
<div class="card">
    ...
    <p class="sub">Enter your staff email address and we'll send you a secure link to reset your dashboard password.</p>
    ...
    <?= form_open('auth/forgot_password') ?>
        ...
        <input type="email" id="email" name="email" placeholder="jane.doe@iit.ac.lk" required autofocus>
